...
def fold_for_f(real_loads, dataTrainVal, features_names, n_loads_to_use=6, n_examples_for_load=15):
    groups_indices = []
...
def objective(params, clf, dataTrainVal, real_loads, features_names):
        ...
        with open(os.path.join(os.getcwd(), filename), "r") as file:
            ...
            for load in loads:
                ...
                for iteration in loop_opt:
                    ...
                    f = partial(objective, clf=clf, dataTrainVal=dataTrainVal, real_loads=real_loads, features_names=features_names)
